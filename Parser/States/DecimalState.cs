...
public class DecimalState : IState
{
    ...
    public DecimalState(List<ParserError> errors, StringHelper stringHelper, Dictionary<LexemeType, IState> StateMap)
    {
        this.errors = errors;
    ...
    public bool Handle()
    {
        ...
        {
            ParserError error = new ParserError("Ожидалась вещественная часть числа или оператор конца выражения \";\"", stringHelper.Index + 1, stringHelper.Index + 1);
            while (true)
            {
