...
### Задачи
#### №1
Построить РВ для того, чтобы сопоставить все числа, которые
не заканчиваются на 0.
`string pattern = @"\b\d*[1-9]\b";`
<img src="/README_images/regularsNonLastNumberZero.png">
#### №2
Построить РВ, описывающее однострочные комментарии
(язык Python).
` string pattern = @"#.*";`
<img src="/README_images/regularsPyComments.png">
#### №3
Построить РВ, описывающее российские автомобильные
номера.
