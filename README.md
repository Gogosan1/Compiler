...
|---|---|---|
|42|	Объявление вещественной константы с инициализацией на языке С/С++|	const	double PI = 3.141592;|
...
|--|--|--|--|
|27| Объявление вещественной константы с инициализацией на языке C/C++| const double PI = 3.14159265359; | (ссылка)|

прмеры допустимых строк (ссылка)
